<template>
    <div :class="cl.priceFilter">
        <h3 :class="cl.priceFilterTitle">Цена</h3>
        <form :class="cl.priceFilterForm">
            <div :class="[cl.priceFilterInputShell, isMinActive ? cl.active : '']">
                <p v-show="minPriceValue === ''" :class="cl.priceFilterInputFakePh">от</p>
                <Input
                    v-model="minPriceValue"
                    :class-name="cl.priceFilterInput"
            ...
            <div :class="[cl.priceFilterInputShell, isMaxActive ? cl.active : '']">
                <p v-show="maxPriceValue === ''" :class="cl.priceFilterInputFakePh">до</p>
                <Input
...
const validatePriceInput = () => {
    ...
    if (minStr === '') {
        ...
        isMinCorrect.value =
            !isNaN(numberedMinValue) && numberedMinValue >= 0 && isFinite(numberedMinValue)
    }
    if (maxStr === '') {
        ...
        isMaxCorrect.value =
            !isNaN(numberedMaxValue) && numberedMaxValue >= 0 && isFinite(numberedMaxValue)
    }
