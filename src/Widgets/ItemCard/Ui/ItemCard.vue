<template>
    <div :class="cl.card">
        <div :class="cl.cardTop">
            ...
            <h5 :class="cl.cardDiscount" v-if="item.discount > 0">
                {{ item.discount }}%
            </h5>
        </div>
        <div :class="cl.cardBottom">
            ...
            <div :class="cl.cardInStock" v-if="item.isInStock">
                <div :class="cl.cardPrices">
                    <h4 :class="cl.cardDiscountPrice">
                        {{ item.priceWithDiscount }} ₽
                    </h4>
                    <h5 v-if="item.discount !== 0" :class="cl.cardPrice">
                        {{ item.fullPrice }} ₽
                    </h5>
                </div>
                <Button :className="cl.cardAddToCartButton">
                    Купить
                </Button>
            </div>
            <Button :className="cl.cardNoStockButton" v-else>
